...
public class Twee3PassageContentImpl extends ASTWrapperPsiElement implements Twee3PassageContent {

  public Twee3PassageContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Twee3Visitor visitor) {
    visitor.visitPassageContent(this);
  }
  ...
  public @NotNull String getText() {
    return Twee3PsiImplUtil.getText(this);
  }
