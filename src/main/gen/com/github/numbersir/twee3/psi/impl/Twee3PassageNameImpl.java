...
public class Twee3PassageNameImpl extends ASTWrapperPsiElement implements Twee3PassageName {

  public Twee3PassageNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Twee3Visitor visitor) {
    visitor.visitPassageName(this);
  }
